export const getRaceView = () => {

  const selectRaces = document.querySelector('#selectRaces');
  selectRaces.addEventListener('change', (event) => {

    const selectedRace = event.target.value;

    // redirection en fonction du select
