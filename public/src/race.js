...
export const race = function(urlParams) {
  ...
  avatar.src = "./public/images/" + avatarName + ".png";
  ...
  btnChrono.addEventListener("click", (event) => {
    ...
    // On charge les opérations de la course sélectionnée,
    if (raceType === "sprint") {
    ...
    // Focus sur l'input de la réponse
    chiffre3.focus();
        ...
        [sign, nb1, nb2] = raceDetails.operations[i];
          ...
          if (raceType === "sprint") {
            ...
            if (i >= 74 | i < 10) {
              ...
              avatar.src = "./public/images/" + avatarName + "-monte.png";
              avatar.style.removeProperty("bottom");
              avatar.style.left = "20px";
              elmtModifie.appendChild(avatar);
            } else if (i >= 30 && i < 54) {
              avatar.src = "./public/images/" + avatarName + "-en-haut.png";
              avatar.style.removeProperty("left");
              avatar.style.bottom = "20px";
              elmtModifie.appendChild(avatar);
            } else if (i >= 54 && i < 74) {
              avatar.src = "./public/images/" + avatarName + "-descend.png";
              avatar.style.removeProperty("bottom");
              avatar.style.left = "20px";
              elmtModifie.appendChild(avatar);
            }
