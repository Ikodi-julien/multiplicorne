        ...
        <div class="content__header__profil__avatars">
          ...
          <div class="photo">
            <div class="photo__profil">
              <img src="./public/avatars/mini_<?php
              $photoProfil = "./public/avatars/mini_". $pseudo . ".png";
            ...
            <div class="photo__avatar">
              <img src="./public/images/<?php echo $_SESSION['avatar'];?>.png" alt="Image Avatar">
            </div>
          </div>
    ...
    <ul>
      ...
      <li>
        ...
        <select name="selectRaces" class="content__header__nav__select" id="selectRaces">
          ...
          <option value="addition">- Sprint Additions</option>
          <option value="soustraction">- Sprint Soustractions</option>
          <option value="multiplication">- Sprint Multiplications</option>
          <option value="marathonAddSub">- Marathon Additions et Soustractions</option>
